                            ...
                            @foreach ($daftarckp as $data)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @switch($data->ckp_status)
                                            @case('CKP Approved')
                                            <span class="badge bg-success">{{ $data->ckp_status }}</span>
                                            @break

                                            @case('CKP Submitted')
                                            <span class="badge bg-primary">{{ $data->ckp_status }}</span>
                                            @break

                                            @case('Penilaian Lengkap')
                                            <span class="badge bg-warning">{{ $data->ckp_status }}</span>
                                            @break

                                            @case('Penilaian Belum Lengkap')
                                            <span class="badge bg-danger">{{ $data->ckp_status }}</span>
                                            @break
