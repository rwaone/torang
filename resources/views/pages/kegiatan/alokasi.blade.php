            ...
            <div class="card">
                ...
                <div class="card-body table-reponsive">
                    <form action="/kegiatan" method="post">
                        ...
                        <input type="text" name="request" value="alokasi" hidden>
                        <div class="form-group">
                            <label class="control-label" for="pegawai_id">Pegawai</label>
                            <select id="pegawai_id" class="form-control select2bs4" name="pegawai_id">
                                <option value="" selected disabled>Pilih Pegawai</option>
                                @foreach ($pegawais as $pegawai)
                                    <option {{ old('pegawai_id') == $pegawai->id ? 'selected' : '' }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                ...
                                <input type="text"
                                    ...
                                    data-target="#reservationdate" data-toggle="datetimepicker" autocomplete="off" name="tanggal"
                        ...
                        <div class="form-group">
                            ...
                            <select id="butir_id" class="form-control select2bs4" name="butir_id">
                                ...
                                @endforeach
                                <option {{ old('butir_id') == $butir->id ? 'selected' : '' }} value="1">Lainnya</option>
                            </select>
                            <div class="help-block"></div>
                        </div>
