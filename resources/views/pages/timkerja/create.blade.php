            ...
            <div class="card">
                ...
                <div class="card-body table-reponsive">
                    <form action="/timkerja" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select id="satker_id" class="form-control select2bs4" name="satker_id" required>
                                ...
                                @foreach ($satkers as $satker)
                                    <option {{ old('satker_id') == $satker->id ? "selected" : "" }} value="{{ $satker->id }}">{{ $satker->nama }}</option>
                                @endforeach
                            </select>
                            <div class="help-block"></div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label" for="ketua_id">Ketua Tim:</label>
                            <select id="ketua_id" class="form-control select2bs4" name="ketua_id" required>
                                <option value="" disabled selected>Pilih Ketua Tim</option>
                                @foreach ($pegawais as $pegawai)
                                    <option {{ old('ketua_id') == $pegawai->id ? "selected" : "" }} value="{{ $pegawai->id }}">{{ $pegawai->nama }}</option>
                                @endforeach
                            </select>
                            <div class="help-block"></div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label" for="anggota">Multiple</label>
                            <select id="anggota" name="anggota[]" class="select2bs4" multiple="multiple" data-placeholder="Pilih Anggota Tim" style="width: 100%;">
                                @foreach ($pegawais as $pegawai)
                                    <option {{ old('ketua_id') == $pegawai->id ? "selected" : "" }} value="{{ $pegawai->id }}">{{ $pegawai->nama }}</option>
                                @endforeach
                            </select>
