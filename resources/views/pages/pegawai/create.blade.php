                    ...
                    <form action="/pegawai" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="nip_lama" class="form-control @error('nip_lama') is-invalid @enderror"
                                name="nip_lama" required value="{{ old('nip_lama') }}">
                            @error('nip_lama')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="nip_baru" class="form-control @error('nip_baru') is-invalid @enderror"
                                name="nip_baru" required value="{{ old('nip_baru') }}">
                            @error('nip_baru')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select id="golongan_id" class="form-control select2bs4" name="golongan_id" required>
                                ...
                                @foreach ($golongans as $golongan)
                                    <option {{ old('golongan_id') == $golongan->id ? 'selected' : '' }}
                                        value="{{ $golongan->id }}">
                        ...
                        <div class="form-group">
                            ...
                            <select id="jabatan_id" class="form-control select2bs4" name="jabatan_id" required>
                                ...
                                @foreach ($jabatans as $jabatan)
                                    <option {{ old('jabatan_id') == $jabatan->id ? 'selected' : '' }}
                        ...
                        <div class="form-group">
                            ...
                            <select id="satker_id" class="form-control select2bs4" name="satker_id" required>
                                ...
                                @foreach ($satkers as $satker)
                                    <option {{ old('satker_id') == $satker->id ? 'selected' : '' }}
                                        value="{{ $satker->id }}">{{ $satker->nama }}</option>
                                @endforeach
                            </select>
                            <div class="help-block"></div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select id="atasan_id" class="form-control select2bs4" name="atasan_id" required>
                                ...
                                @foreach ($strukturals as $struktural)
                                    <option {{ old('atasan_id') == $struktural->id ? 'selected' : '' }}
                                        value="{{ $struktural->id }}">{{ $struktural->nama }}</option>
                                @endforeach
                            </select>
                            <div class="help-block"></div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select id="status" class="form-control select2bs4" name="status" required>
                                ...
                                <option value="TB" {{ old('status') == 'TB' ? "selected" : "" }} >Tugas Belajar</option>
                            ...
                            <div class="input-group">
                                <div class="custom-file">
                                    ...
                                    <input type="file" class="custom-file-input @error('foto') is-invalid @enderror"
                                        id="customFile" name="foto" onchange="previewImage()">
                                    @error('foto')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
