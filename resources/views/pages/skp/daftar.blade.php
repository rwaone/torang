            ...
            <div class="card">
                ...
                <div class="card-body table-reponsive">
                    ...
                    <div class="float-start">
                        <a href="/skp/create" class="btn btn-success">
                    ...
                    <table id="tabelkegiatan" class="table table-sm table-hover text-sm">
                        <thead>
                            <tr>
                                <th class="text-center">Sasaran Kinerja Atasan</th>
                                <th class="text-center">Rencana Kinerja</th>
                                <th class="text-center">Aspek</th>
                                <th class="text-center">Indikator Kinerja Individu</th>
